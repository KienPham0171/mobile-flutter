...
import 'package:real_app/dialog/add_money_dialog.dart';
...
class ProfilePage1 extends StatelessWidget {
  ...
  void showAddGroupDialog(BuildContext context) async{
...
class _ProfileInfoRow extends StatelessWidget {
  ...
  final List<ProfileInfoItem> _items = const [
    ProfileInfoItem("Group", 3),
    ProfileInfoItem("Money", 1200000),
    ProfileInfoItem("Meal", 17),
  ];
